...
clf = joblib.load('../kmeans_surf.pkl')     # taking trained dump data from kmean_surf.py
train = []
labels=[]
...
Car_max_limit = 2
Motorcycle_limit = 0
Motorcycle_max_limit = 2
Rickshaw_limit = 0
Rickshaw_max_limit = 2
Autorickshaw_limit = 0
Autorickshaw_max_limit = 2
...
svmclf = svm.LinearSVC(C=0.1)
svmclf.fit(fv, labels)        #  training the classifier
joblib.dump(svmclf, 'svm_surf_coarse_linear_0.pkl')         # dumping trained classifier
