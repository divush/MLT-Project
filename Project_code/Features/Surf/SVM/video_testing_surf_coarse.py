...
treeclf = joblib.load('svm_surf_coarse_rbf_100.pkl')  # chnage name accordingly
# treeclf = joblib.load('forest_surf_20.pkl')
...
def features(pic):
	...
	return None
Person_count=0
cap1 = cv2.VideoCapture('test_video/videosample5.AVI')         # takes binary image
cap2 = cv2.VideoCapture('videos/videosample5.mov')             # corresponding original video
labels = {1:"Person", 2:"2-Wheeler", 3:"3-Wheeler", 4:"4-Wheeler"}
