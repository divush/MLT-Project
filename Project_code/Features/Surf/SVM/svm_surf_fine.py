...
person_max_limit = 70
Bicycle_limit = 0
Bicycle_max_limit = 60
Car_limit = 0
Car_max_limit = 50
Motorcycle_limit = 0
Motorcycle_max_limit = 40
Rickshaw_limit = 0
Rickshaw_max_limit = 30
Autorickshaw_limit = 0
Autorickshaw_max_limit = 20
...
joblib.dump(svmclf, 'svm_surf_fine.pkl')           # dumping trained classifier